...
urlpatterns = [
    ...
    path('api/gender-distribution/', views.gender_distribution,
         name='gender-distribution'),
    path('api/gender-distribution1/', views.gender_distribution1,
         name='gender-distribution1'),
    
    path('api/education-distribution/', views.education_distribution,
         name='education-distribution'),  # New endpoint
    path('api/education-distribution1/', views.education_distribution1,
         name='education-distribution1'),  # New endpoint
    ...
    path('api/residence-type-distribution1/', residence_type_distribution1,
         name='residence-type-distribution1'),
    path('api/pension-exclusion-stats/',
         views.pension_and_exclusion_stats, name='pension_exclusion_stats'),
    
    path('api/pension-exclusion-stats1/',
         views.pension_and_exclusion_stats1, name='pension_exclusion_stats1'),
    path('api/survey-data-2016/', views.survey_data_2016_table,
         name='survey_data_2016_table'),
    path('api/survey-data-2021/', views.survey_data_2021_table,
         name='survey_data_2021_table'),
